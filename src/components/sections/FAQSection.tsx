...
const faqs = [
  {
    ...
    answer: 'ข้อมูลทุกอย่างจะถูกเข้ารหัสและปกป้องด้วยมาตรฐานความปลอดภัยระดับองค์กร'
  },
  {
    question: 'ใครสามารถใช้งานระบบนี้ได้บ้าง?',
  ...
  },
  {
    ...
    answer: 'AI Assistant ช่วยตอบคำถามและให้คำแนะนำเกี่ยวกับการใช้งานระบบและการจัดการความคลาดเคลื่อนในองค์กร'
  }
];
